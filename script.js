...
let beatMap = [
    [0.9, 0], [1.48, 2], [2.11, 1], //flash
    [3.01, 0], [3.61, 0],
    [4.32, 2], [4.98, 2], [5.50, 1], [6.9, 2], [7.93, 0],
    [8.64, 1], [9.31, 2], [10.42, 1], [11.42, 1], [12.53, 2],
    [13.39, 0], [14.13, 1], [15.06, 2], [15.75, 1], [16.9, 0],
    [18.01, 2], [18.89, 2], [19.6, 1], [20.24, 0], [21.41, 0],
    [22.02, 1], [22.82, 2], [23.84, 0], [24.87, 1], [25.47, 2],
    [26.48, 1], [27.2, 1], [28.2, 2], [29.3, 1], [30.37, 0],
    [31.03, 2], [31.75, 0], [32.43, 1], [33.28, 2], [34.47, 0],
    [35.18, 1], [36.13, 2], [37.04, 0], [37.8, 0], [38.7, 2],
    [39.7, 2], [41.0, 1], [42.16, 2], [43.0, 0], [43.78, 1],
    [44.59, 2], [45.43, 1], [46.32, 1]
];
...
function showHitFeedback(text, note) {
    ...
    feedback.style.left = note.style.left;
    feedback.style.top = note.style.top;
